 ...
 *
 */
public class PrefixContactLinkRule implements Rule {
...
//	protected static String URL_RULE = "[a-zA-Z0-9-_/:.]*contact[a-zA-Z0-9-._/]*";
	protected static String CONTACT_LINK_RULE = 
			"<(a|link)(" + ContactLinkRule.VALID_TAG_CHARS + ")*contact(" + ContactLinkRule.VALID_TAG_CHARS + ")*href=\"(?<" + URL_GROUP_NAME + ">" + "[a-zA-Z0-9-_/?=:.]+" + ")\"(" + ContactLinkRule.VALID_TAG_CHARS + ")*>";
